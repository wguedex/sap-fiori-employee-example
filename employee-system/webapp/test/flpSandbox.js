		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sapui5comemployeesystem-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapui5comemployeesystem-display": {
								"semanticObject": "sapui5comemployeesystem",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapui5.com.employeesystem",
									"url": sap.ui.require.toUrl("sapui5/com/employeesystem")
								}
							}
						}
					}
